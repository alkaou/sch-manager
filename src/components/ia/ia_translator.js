const translations = {
  ...
  welcome_message: {
    Français:
      "Bonjour ! Je suis Fatoumata, votre assistante IA spécialisée dans la gestion d'établissements scolaires. Comment puis-je vous aider aujourd'hui ?",
    Anglais:
      "Hello! I'm Fatoumata, your AI assistant specialized in school management. How can I help you today?",
    Bambara:
  ...
  input_placeholder: {
    Français:
      "Tapez votre message... (Entrée pour envoyer, Ctrl+Entrée pour nouvelle ligne)",
    Anglais: "Type your message... (Enter to send, Ctrl+Enter for new line)",
    Bambara:
      "I ka bataki sɛbɛn... (Enter walasa ka ci, Ctrl+Enter walasa ka layini kura kɛ)",
  },
  send_message: {
  ...
  help_intro: {
    Français:
      "Fatoumata est votre assistante IA spécialisée dans la gestion d'établissements scolaires. Elle peut vous aider avec :",
    Anglais:
      "Fatoumata is your AI assistant specialized in school management. She can help you with:",
    Bambara:
      "Fatoumata ye i ka IA dɛmɛbaga ye min bɛ lakɔli jɔyɔrɔ ɲɛnabɔli la. A bɛ se ka i dɛmɛ ninnu na:",
  },
  ...
  supported_files: {
    Français:
      "Fichiers supportés : PDF, DOCX, DOC, TXT, Images (PNG, JPG, JPEG)",
