              ...
              {activeSection === "general" && (
                <div className="space-y-6">
                  ...
                  <div className="border border-gray-200 rounded-lg overflow-hidden">
                    ...
                    >
                      <h4 className={`font-medium ${_text_color}`}>Informations personnelles</h4>
                  ...
                  <div className="border border-gray-200 rounded-lg overflow-hidden">
                    ...
                    >
                      <h4 className={`font-medium ${_text_color}`}>Informations professionnelles</h4>
                    ...
                    {expandedSections.professional && (
                      <div className="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          <label className={`block mb-1 text-sm font-medium ${_text_color}`}>
                            Date de fin de service (optionnel)
                          </label>
                          <input
                            type="date"
              ...
              {activeSection === "professor" && (
                <div className="space-y-6">
                  ...
                  <div className="border border-gray-200 rounded-lg overflow-hidden">
                    ...
                    >
                      <h4 className={`font-medium ${_text_color}`}>Type d'emploi et rémunération</h4>
                        ...
                        <div>
                          ...
                          <div className="flex space-x-4">
                            <label className="flex items-center space-x-2">
                              ...
                              />
                              <span className={_text_color}>Permanent</span>
                            </label>
                            <label className="flex items-center space-x-2">
                              <input
                                type="radio"
                                ...
                                className="w-4 h-4 text-blue-600 focus:ring-blue-500"
                              />
                              <span className={_text_color}>Vacataire</span>
                            </label>
                          </div>
                        </div>
              ...
              {activeSection === "other" && (
                <div className="space-y-6">
                  <h4 className={`text-md font-semibold mb-4 ${_text_color}`}>
                    Configuration pour les autres postes: {formData.postes.filter(p => p !== 'Professeurs').join(', ')}
                  </h4>
