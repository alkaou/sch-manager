...
const PayementsTabs = ({
  ...
  return (
    <div
      className={`${tabsBgColor} border-b-2 mt-2 sm:mt-3 md:mt-5 ${borderColor} shadow-md`}
    >
        ...
        <div className="flex overflow-hidden scrollbar-thin scrollbar-custom">
          {tabs.map((tab) => (
            <motion.button
              ...
              className={`flex items-center space-x-1 px-2 sm:px-3 md:px-4 py-2 sm:py-2.5 md:py-3 text-xs sm:text-sm font-medium transition-colors relative ${
                activeTab === tab.id
                  ? `${activeTextColor}`
