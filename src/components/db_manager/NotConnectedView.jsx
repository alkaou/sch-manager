...
const NotConnectedView = ({ theme, textColor, setLoginModalOpen }) => {
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center text-center">
        ...
        >
          <FaLock className={`text-6xl ${textColor}`} />
        </motion.div>
        ...
        <p className={`mb-8 text-lg ${textColor} opacity-80`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-2xl">
          ...
          >
            <FaDatabase className={`text-4xl mb-4 ${textColor}`} />
