  ...
  useEffect(() => {
    if (db && selectedPaymentSystem) {
      ...
      if (paymentSystem && paymentSystem.classes && all_classes.length > 0) {
        ...
        setAvailableClasses([{ id: 'all', name: t('all_classes') }, ...classes]);
      } else {
        // Si aucun système n'est sélectionné ou s'il n'a pas de classes, afficher une liste vide
        setAvailableClasses([{ id: 'all', name: t('all_classes') }]);
      }
    }
  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <h2 className={`text-2xl font-bold ${text_color}`}>{t("monthly_payment_statistics")}</h2>
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      <div className="flex items-center">
                        ...
                        <span className={`${textColorClass}`}>{t('total_expected')}:</span>
                      </div>
                    ...
                    <div className="flex justify-between items-center">
                      <div className="flex items-center">
                        ...
                        <span className={`${textColorClass}`}>{t('total_received')}:</span>
                      </div>
                    ...
                    <div className="flex justify-between items-center">
                      <div className="flex items-center">
                        ...
                        <span className={`${textColorClass}`}>{t('average_rate')}:</span>
                      </div>
                ...
                <div className="overflow-x-auto">
                  <table className="min-w-full divide-y divide-gray-200">
                    <thead className={headerBgColor}>
                      <tr>
                        <th className={`px-6 py-3 text-left text-xs font-medium ${textColorClass} uppercase tracking-wider`}>{t('month')}</th>
                        <th className={`px-6 py-3 text-left text-xs font-medium ${textColorClass} uppercase tracking-wider`}>{t('students')}</th>
                        <th className={`px-6 py-3 text-left text-xs font-medium ${textColorClass} uppercase tracking-wider`}>{t('paid')}</th>
                        <th className={`px-6 py-3 text-left text-xs font-medium ${textColorClass} uppercase tracking-wider`}>{t('expected')}</th>
                        <th className={`px-6 py-3 text-left text-xs font-medium ${textColorClass} uppercase tracking-wider`}>{t('received')}</th>
                        <th className={`px-6 py-3 text-left text-xs font-medium ${textColorClass} uppercase tracking-wider`}>{t('rate')}</th>
                      </tr>
                    </thead>
