          ...
          {hasPaymentSystems && (
            <>
              ...
              <div className="mb-3 sm:mb-4 relative">
                ...
                <input
                  type="text"
                  placeholder={t("search_payment_system")}
                  value={searchTerm}
              ...
              <div className="mb-2">
                <label className={`block ${_text_color} mb-1 sm:mb-1.5 text-xs sm:text-sm font-medium`}>{t("sort_by")}:</label>
                <div className="relative">
                  ...
                  >
                    <option value="date-desc">{t("date_recent_to_old")}</option>
                    <option value="name-asc">{t("name_a_to_z")}</option>
                    <option value="name-desc">{t("name_z_to_a")}</option>
                    <option value="date-asc">{t("date_old_to_recent")}</option>
                  </select>
        ...
        <div className="flex-1 overflow-hidden p-2 sm:p-3 md:p-4">
          {!hasPaymentSystems ? (
            <div className="flex flex-col items-center justify-center h-full p-3 sm:p-4 md:p-6 text-center">
              ...
              <p className={`${_text_color} font-semibold text-sm sm:text-base md:text-lg mb-1 sm:mb-2`}>{t("no_payment_system_configured")}</p>
              <p className={`${_text_color} opacity-80 mb-4 sm:mb-6 text-xs sm:text-sm max-w-xs`}>
                {t("please_configure_payment_system")}
              </p>
              <motion.button
            ...
            <div className="flex flex-col items-center justify-center h-full p-3 sm:p-4 md:p-6 text-center">
              ...
              <p className={`${_text_color} font-semibold text-sm sm:text-base md:text-lg mb-1 sm:mb-2`}>{t("no_system_found")}</p>
              <p className={`${_text_color} opacity-80 mb-4 sm:mb-6 text-xs sm:text-sm max-w-xs`}>
                {searchTerm ? t("no_system_matches_search") : t("please_add_payment_systems")}
              </p>
              {!searchTerm && (
                <motion.button
                  whileHover={{ scale: 1.03 }}
