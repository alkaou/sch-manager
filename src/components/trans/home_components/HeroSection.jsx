...
const HeroSection = ({ setIsOpenPopup, data, isOthersBGColors }) => {
  ...
  return (
    <section id="home" className={`relative pt-10 sm:pt-14 md:pt-16 lg:pt-20 pb-8 sm:pb-10 md:pb-12 lg:pb-14 overflow-hidden`}>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-4 sm:gap-5 md:gap-6 lg:gap-8 lg:space-y-0">
          ...
          >
            <div className="relative">
              ...
              >
                <svg className="w-2/3 h-2/3 text-blue-600 dark:text-blue-400" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <motion.path
              ...
              >
                <div className="flex items-center">
                  ...
                  <span className="font-semibold text-xs sm:text-xs md:text-sm">{live_language.students_management || "Gestion des élèves"}</span>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-center">
                  ...
                  <span className="font-semibold text-xs sm:text-xs md:text-sm">{live_language.analytics_nav || "Analyses"}</span>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-center">
                  ...
                  <span className="font-semibold text-xs sm:text-xs md:text-sm">{live_language.security_text || "Sécurité"}</span>
                </div>
              </motion.div>
            </div>
          </motion.div>
