...
const translations = {
  ...
  "click_to_add_students": {
    "Français": "Cliquez sur le bouton ci-dessous pour créer votre première liste.",
  ...
  "confirm_delete_list_message": {
    "Français": "Êtes-vous sûr de vouloir supprimer la liste '{listName}' ? Cette action ne peut pas être annulée.",
    "Anglais": "Are you sure you want to delete the list '{listName}'? This action cannot be undone.",
    "Bambara": "I dalen don i bɛ lisi '{listName}' jɔsi? Nin baara tɛ se ka sɛgɛn kɔ."
  },
  ...
  "confirm_delete_message": {
    "Français": "Êtes-vous sûr de vouloir supprimer cette liste ? Cette action ne peut pas être annulée.",
    "Anglais": "Are you sure you want to delete this list? This action cannot be undone.",
  ...
  "cannot_change_list_type": {
    "Français": "Cette liste contient déjà des {type}. Veuillez les supprimer avant de changer le type.",
    "Anglais": "This list already contains {type}. Please remove them before changing the type.",
    "Bambara": "Nin lisi in kɔnɔ {type} bɛ ka ban. I k'olu bɔ lisi in na sani i ka suguyali yɛlɛma."
  },
  "list_type_changed": {
