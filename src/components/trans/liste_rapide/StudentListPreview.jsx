                    ...
                    >
                      ...
                      <td className={`border ${tableBorderColor} p-2 text-center no-print`}>
                        <motion.button
                          ...
                          whileHover={{ scale: 1.1 }}
                          whileTap={{ scale: 0.9 }}
                          title={isEmployeeList ? t("remove_employee") : t("remove_student")}
                        >
                          <Trash size={16} />
                        </motion.button>
                      </td>
      ...
      {listItems.length === 0 && (
        <div className="text-center p-8">
          <p className={`text-lg ${text_color}`}>
            {isEmployeeList ? t("no_employees_in_list") : t("no_students_in_list")}
          </p>
          <p className={`${text_color} opacity-75`}>
            {t("click_button_to_start", { button: isEmployeeList ? t("add_employees") : t("add_students") })}
          </p>
        </div>
      )}
    </div>
