...
const StudentListSidebar = ({
  ...
  return (
    <div className={`p-1 ${textClass} ${appBgColor} h-full`}>
      <h2 className="text-lg font-semibold mb-4">{t('parameters_title')}</h2>
      ...
      <div className="max-h-500 overflow-y-auto scrollbar-custom">
        ...
        <div className={`mb-4 border ${borderColor} rounded-lg overflow-hidden`}>
          ...
          >
            <h3 className="font-medium">{t('title_style')}</h3>
          ...
          <div className="space-y-2 max-h-60 overflow-y-auto scrollbar-custom">
            {expandedSections.titleStyle && (
              <div className="p-3 space-y-3">
                {/* Title Text */}
                <div>
                  <label className="block mb-1 text-sm font-medium">{t('title_text')}</label>
                  <input
                    type="text"
                ...
                {/* Font Family */}
                <div>
                  <label className="block mb-1 text-sm font-medium">{t('font')}</label>
                  <select
                ...
                {/* Font Size */}
                <div>
                  <label className="block mb-1 text-sm font-medium">{t('size')}</label>
                ...
                {/* Text Style Buttons */}
                <div>
                  <label className="block mb-1 text-sm font-medium">{t('text_style')}</label>
                ...
                {/* Text Alignment */}
                <div>
                  <label className="block mb-1 text-sm font-medium">{t('alignment')}</label>
                  <div className="flex space-x-2">
                    <motion.button
                ...
                <div>
                  <label className="block mb-1 text-sm font-medium">{t('title_border')}</label>
                ...
                {(list.title.style.border || list.title.style.borderBottom || list.title.style.borderTop) && (
                  <div>
                    <label className="block mb-1 text-sm font-medium">{t('border_style')}</label>
                    <div className="grid grid-cols-2 gap-2">
                      <div>
                        <label className="block mb-1 text-xs">{t('thickness')}</label>
                        <select
                      ...
                      <div>
                        <label className="block mb-1 text-xs">{t('style')}</label>
                        <select
                ...
                {list.title.style.boxShadow && (
                  <div>
                    <label className="block mb-1 text-sm font-medium">{t('shadow_intensity')}</label>
                    <div className="flex items-center">
                      <input
                        type="range"
                        min="1"
                ...
                <div>
                  <label className="block mb-1 text-sm font-medium">{t('color')}</label>
                ...
                <div>
                  <label className="block mb-1 text-sm font-medium">{t('advanced_options')}</label>
                  <div className="grid grid-cols-2 gap-2">
                    <div className="flex items-center">
                      <input
                        type="checkbox"
                      ...
                      />
                      <label htmlFor="text-shadow" className="text-sm">{t('text_shadow')}</label>
                    </div>
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        className="mr-2 h-4 w-4"
                      />
                      <label htmlFor="text-uppercase" className="text-sm">{t('uppercase')}</label>
                    </div>
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        className="mr-2 h-4 w-4"
                      />
                      <label htmlFor="text-letterspacing" className="text-sm">{t('letter_spacing')}</label>
                    </div>
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        className="mr-2 h-4 w-4"
                      />
                      <label htmlFor="text-border" className="text-sm">{t('outline')}</label>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className={`mb-4 border ${borderColor} rounded-lg overflow-hidden`}>
          ...
          >
            <h3 className="font-medium">{t('standard_headers', { count: selectedHeadersCount, isEmployeeList: isEmployeeList ? '- Employés' : '- Élèves' })}</h3>
          ...
          {expandedSections.headers && (
            <div className="p-3">
              <p className="text-sm mb-2 opacity-75">
                {t('select_up_to_10_headers', { count: 10 })}
              </p>
        ...
        <div className={`mb-4 border ${borderColor} rounded-lg overflow-hidden`}>
          ...
          >
            <h3 className="font-medium">{t('custom_headers')}</h3>
        ...
        <div className={`mb-4 border ${borderColor} rounded-lg overflow-hidden`}>
          ...
          >
            <h3 className="font-medium">{t('page_orientation')}</h3>
        ...
        <div className={`mb-4 border ${borderColor} rounded-lg overflow-hidden`}>
          ...
          >
            <h3 className="font-medium">{t('custom_message')}</h3>
            ...
            <div className="p-3 space-y-3">
              <div className="flex items-center">
                <input
                  ...
                  className="mr-2 h-4 w-4"
                />
                <label htmlFor="show-custom-message">{t('show_custom_message')}</label>
              </div>

              {list.customMessage.show && (
                <>
                  <div>
                    <label className="block mb-1 text-sm font-medium">{t('message_text')}</label>
                    <input
                      type="text"
                      ...
                      placeholder={t('example_message')}
                      className={`w-full p-2 rounded-lg border ${borderColor} ${inputBgColor}`}
                    />
                  </div>

                  <div>
                    <label className="block mb-1 text-sm font-medium">{t('your_name')}</label>
                    <input
                      type="text"
        ...
        <div className={`mb-4 border ${borderColor} rounded-lg overflow-hidden`}>
          ...
          >
            <h3 className="font-medium">{t('country_header')}</h3>
            ...
            <div className="p-3 space-y-3">
              <div className="flex items-center">
                <input
                  ...
                  className="mr-2 h-4 w-4"
                />
                <label htmlFor="show-country-infos">{t('show_country_header')}</label>
              </div>
              ...
              {list.countryInfosHeader.show && (
                <div className="flex items-center">
                  <input
                    ...
                    className="mr-2 h-4 w-4"
                  />
                  <label htmlFor="is-cap">{t('cap_instead_of_academy')}</label>
                </div>
              )}
            </div>
          )}
