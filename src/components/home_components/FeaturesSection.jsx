...
import {
  FileText, Users, Star, BarChart2, DollarSign,
  BookOpen, Database, Calendar, Calculator, Shield,
  ...
  const features = [
    {
      ...
      description: live_language.bulletins_description || "Générez des bulletins scolaires personnalisables avec calcul automatique des moyennes et des rangs.",
      delay: 0.1
    },
    {
      id: 2,
      ...
      description: live_language.compositions_description || "Enregistrez et gérez facilement les notes des élèves pour chaque évaluation et trimestre.",
      delay: 0.2
    },
    {
      id: 3,
      ...
      description: live_language.lists_description || "Organisez vos élèves par classe et générez des listes personnalisées et exportables.",
      delay: 0.3
    },
    {
      id: 4,
      ...
      description: live_language.analytics_description || "Visualisez les performances avec des graphiques intuitifs et suivez l'évolution des résultats.",
      delay: 0.4
    },
    {
      id: 5,
      ...
      description: live_language.finance_description || "Suivez les paiements des frais scolaires et générez des rapports financiers détaillés.",
      delay: 0.5
    },
    {
      id: 6,
      ...
      description: live_language.read_description || "Accédez à une bibliothèque de ressources éducatives pour enrichir votre enseignement.",
      delay: 0.15
    },
    {
      id: 7,
      ...
      description: live_language.database_description || "Stockez en toute sécurité les informations de votre établissement avec des sauvegardes automatiques.",
      delay: 0.25
    },
    {
      id: 8,
      ...
      description: live_language.calendar_description || "Planifiez les événements scolaires et les évaluations importantes dans un calendrier intégré.",
      delay: 0.35
    },
    {
      id: 9,
      ...
      description: live_language.calculator_description || "Utilisez des outils de calcul intégrés pour les moyennes et les statistiques de classe.",
      delay: 0.45
    }
  ];
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="w-full md:w-1/2 flex justify-center">
              ...
              >
                ...
                <div className="absolute inset-2 rounded-full border-4 border-dashed border-blue-300 dark:border-blue-800 animate-spin" style={{ animationDuration: '30s' }}></div>
