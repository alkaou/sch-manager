...
const StudentListSidebar = ({
  ...
  const standardHeaders = isEmployeeList
    ? standardEmployeeHeaders
    : standardStudentHeaders;
  ...
  return (
    <div className={`p-1 ${textClass} ${appBgColor} h-full`}>
      <h2 className="text-lg font-semibold mb-4">
        {translate("parameters_title", language)}
      </h2>

      <div className="max-h-500 overflow-y-auto scrollbar-custom">
        {/* Title Style Section */}
        <div
          className={`mb-4 border ${borderColor} rounded-lg overflow-hidden`}
        >
          <div
          ...
          >
            <h3 className="font-medium">
              {translate("title_style", language)}
            </h3>
          ...
          <div className="space-y-2 max-h-60 overflow-y-auto scrollbar-custom">
            {expandedSections.titleStyle && (
              <div className="p-3 space-y-3">
                ...
                <div>
                  ...
                  <div className="flex items-center">
                    <motion.button
                      onClick={() => {
                        const currentSize =
                          parseInt(list.title.style.fontSize) || 16;
                        if (currentSize > 12) {
                          onUpdateTitle({
                            style: {
                              ...list.title.style,
                      ...
                      whileTap={{ scale: 0.95 }}
                      disabled={
                        (parseInt(list.title.style.fontSize) || 16) <= 12
                      }
                    >
                      <Minus size={16} />
                    </motion.button>
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.95 }}
                      disabled={
                        (parseInt(list.title.style.fontSize) || 16) >= 48
                      }
                    >
                      <Plus size={16} />
                    </motion.button>
                ...
                <div>
                  <label className="block mb-1 text-sm font-medium">
                    {translate("text_of_style", language)}
                  </label>
                  <div className="flex space-x-2">
                      ...
                      onClick={() =>
                        onUpdateTitle({
                          style: {
                            ...list.title.style,
                            fontWeight:
                              list.title.style.fontWeight === "bold"
                                ? "normal"
                                : "bold",
                          },
                        })
                      }
                      className={`p-2 rounded-lg flex-1 flex justify-center ${
                        list.title.style.fontWeight === "bold"
                          ? buttonPrimary
                          : buttonSecondary
                      }`}
                    ...
                    <motion.button
                      onClick={() =>
                        onUpdateTitle({
                          style: {
                            ...list.title.style,
                            fontStyle:
                              list.title.style.fontStyle === "italic"
                                ? "normal"
                                : "italic",
                          },
                        })
                      ...
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      title={translate("italic", language)}
                    >
                      <Italic size={18} />
                    </motion.button>
                    ...
                    <motion.button
                      onClick={() =>
                        onUpdateTitle({
                          style: {
                            ...list.title.style,
                            textDecoration:
                              list.title.style.textDecoration === "underline"
                                ? "none"
                                : "underline",
                          },
                        })
                      ...
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      title={translate("underline", language)}
                    >
                      <Underline size={18} />
                    </motion.button>
                  </div>
                ...
                <div>
                  ...
                  <div className="flex space-x-2">
                    <motion.button
                      onClick={() =>
                        onUpdateTitle({
                          style: { ...list.title.style, textAlign: "left" },
                        })
                      }
                      className={`p-2 rounded-lg flex-1 flex justify-center ${
                        list.title.style.textAlign === "left"
                          ? buttonPrimary
                          : buttonSecondary
                      }`}
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      title={translate("left", language)}
                    >
                      <AlignLeft size={18} />
                    </motion.button>
                    ...
                    <motion.button
                      onClick={() =>
                        onUpdateTitle({
                          style: { ...list.title.style, textAlign: "center" },
                        })
                      }
                      className={`p-2 rounded-lg flex-1 flex justify-center ${
                        list.title.style.textAlign === "center"
                          ? buttonPrimary
                          : buttonSecondary
                      }`}
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      title={translate("center", language)}
                    >
                      <AlignCenter size={18} />
                    </motion.button>
                    ...
                    <motion.button
                      onClick={() =>
                        onUpdateTitle({
                          style: { ...list.title.style, textAlign: "right" },
                        })
                      }
                      className={`p-2 rounded-lg flex-1 flex justify-center ${
                        list.title.style.textAlign === "right"
                          ? buttonPrimary
                          : buttonSecondary
                      }`}
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      title={translate("right", language)}
                    >
                      <AlignRight size={18} />
                    </motion.button>
                  </div>
                ...
                <div>
                  <label className="block mb-1 text-sm font-medium">
                    {translate("encadrement", language)}
                  </label>
                    ...
                    <motion.button
                      onClick={() =>
                        onUpdateTitle({
                          style: {
                            ...list.title.style,
                            border: list.title.style.border
                              ? undefined
                              : "2px solid black",
                            padding: list.title.style.border
                              ? undefined
                              : "8px",
                            borderRadius: list.title.style.border
                              ? undefined
                              : "0px",
                          },
                        })
                      ...
                      onClick={() =>
                        onUpdateTitle({
                          style: {
                            ...list.title.style,
                            border: undefined,
                            borderBottom: list.title.style.borderBottom
                              ? undefined
                              : "2px solid black",
                            borderTop: undefined,
                            padding: list.title.style.borderBottom
                              ? undefined
                              : "4px 0",
                          },
                        })
                      ...
                      onClick={() =>
                        onUpdateTitle({
                          style: {
                            ...list.title.style,
                            border: undefined,
                            borderTop: list.title.style.borderTop
                              ? undefined
                              : "2px solid black",
                            padding: list.title.style.borderTop
                              ? undefined
                              : "4px 0",
                          },
                        })
                      ...
                      onClick={() =>
                        onUpdateTitle({
                          style: {
                            ...
                            boxShadow: list.title.style.boxShadow
                              ? undefined
                              : "0 2px 10px rgba(0,0,0,0.2)",
                            padding: list.title.style.boxShadow
                              ? undefined
                              : "8px",
                          },
                        })
                  ...
                  <div className="grid grid-cols-2 gap-2">
                      ...
                      onClick={() =>
                        onUpdateTitle({
                          style: {
                            ...
                            border:
                              list.title.style.border &&
                              list.title.style.borderRadius === "8px"
                                ? undefined
                                : "2px solid black",
                            borderRadius: "8px",
                            padding:
                    ...
                    <motion.button
                      onClick={() =>
                        onUpdateTitle({
                          style: {
                            ...list.title.style,
                            backgroundColor: list.title.style.backgroundColor
                              ? undefined
                              : theme === "dark"
                              ? "#374151"
                              : "#f3f4f6",
                            padding: list.title.style.backgroundColor
                              ? undefined
                              : "8px",
                            borderRadius: list.title.style.backgroundColor
                              ? undefined
                              : "4px",
                          },
                        })
                      ...
                      className={`p-2 rounded-lg flex items-center justify-center ${
                        list.title.style.backgroundColor
                          ? buttonPrimary
                          : buttonSecondary
                      }`}
                      whileHover={{ scale: 1.05 }}
                    ...
                    >
                      ...
                      ></div>
                      {translate("colored_background", language)}
                    </motion.button>
                    ...
                    <motion.button
                      onClick={() =>
                        onUpdateTitle({
                          style: {
                            ...
                            border:
                              list.title.style.border &&
                              list.title.style.borderStyle === "double"
                                ? undefined
                                : "4px double black",
                            padding:
                              list.title.style.border &&
                      ...
                      className={`p-2 rounded-lg flex items-center justify-center ${
                        list.title.style.border &&
                        list.title.style.border.includes("double")
                          ? buttonPrimary
                          : buttonSecondary
                      }`}
                      whileHover={{ scale: 1.05 }}
                    ...
                    >
                      ...
                      {translate("double_line", language)}
                    </motion.button>
                      ...
                      onClick={() =>
                        onUpdateTitle({
                          style: {
                            ...list.title.style,
                            background:
                              list.title.style.background &&
                              list.title.style.background.includes("gradient")
                                ? undefined
                ...
                {(list.title.style.border ||
                  ...
                  <div>
                    <label className="block mb-1 text-sm font-medium">
                      {translate("border_style", language)}
                    </label>
                    <div className="grid grid-cols-2 gap-2">
                      <div>
                        <label className="block mb-1 text-xs">
                          {translate("thickness", language)}
                        </label>
                        <select
                          value={parseInt(
                            list.title.style.border?.split("px")[0] ||
                              list.title.style.borderBottom?.split("px")[0] ||
                              "1"
                          )}
                          onChange={(e) => {
                            ...
                            if (list.title.style.border) {
                              ...
                              const borderParts =
                                list.title.style.borderBottom.split(" ");
                              borderParts[0] = width;
                              onUpdateTitle({
                                style: {
                                  ...list.title.style,
                                  borderBottom: borderParts.join(" "),
                                },
                              });
                            } else if (list.title.style.borderTop) {
                              const borderParts =
                                list.title.style.borderTop.split(" ");
                              borderParts[0] = width;
                              onUpdateTitle({
                                style: {
                                  ...list.title.style,
                                  borderTop: borderParts.join(" "),
                                },
                              });
                            }
                          }}
                      ...
                      <div>
                        ...
                        <select
                          value={
                            list.title.style.border?.split(" ")[1] ||
                            list.title.style.borderBottom?.split(" ")[1] ||
                            "solid"
                          }
                          onChange={(e) => {
                        ...
                        >
                          <option value="solid">
                            {translate("solid", language)}
                          </option>
                          <option value="dashed">
                            {translate("dashed", language)}
                          </option>
                          <option value="dotted">
                            {translate("dotted", language)}
                          </option>
                          <option value="double">
                            {translate("double", language)}
                          </option>
                        </select>
                      </div>
                    </div>
                ...
                {list.title.style.boxShadow && (
                  <div>
                    <label className="block mb-1 text-sm font-medium">
                      {translate("shadow_intensity", language)}
                    </label>
                    <div className="flex items-center">
                      <input
                        type="range"
                        ...
                        max="20"
                        value={parseInt(
                          list.title.style.boxShadow?.match(/\d+px/g)?.[1] ||
                            "5"
                        )}
                        onChange={(e) => {
                          ...
                          onUpdateTitle({
                            style: {
                              ...
                              boxShadow: `0 ${
                                intensity / 5
                              }px ${intensity}px rgba(0,0,0,${intensity / 30})`,
                            },
                          });
                        }}
                        className="w-full"
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2">
                    <div
                      ...
                      style={{
                        backgroundColor: list.title.style.color || "#000000",
                      }}
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        onUpdateTitle({
                          style: { ...list.title.style, color: e.target.value },
                        })
                      }
                  ...
                  {showColorPicker && (
                    <div
                      className={`mt-2 p-2 border ${borderColor} rounded-lg ${inputBgColor} grid grid-cols-10 gap-1`}
                    >
                ...
                <div>
                  <label className="block mb-1 text-sm font-medium">
                    {translate("advanced_options", language)}
                  </label>
                  <div className="grid grid-cols-2 gap-2">
                    <div className="flex items-center">
                      <input
                        ...
                        id="text-shadow"
                        checked={
                          list.title.style.textShadow !== "none" &&
                          list.title.style.textShadow !== undefined
                        }
                        onChange={(e) =>
                          onUpdateTitle({
                            style: {
                      ...
                      <label htmlFor="text-shadow" className="text-sm">
                        {translate("text_shadow", language)}
                      </label>
                    </div>
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        className="mr-2 h-4 w-4"
                      />
                      <label htmlFor="text-uppercase" className="text-sm">
                        {translate("uppercase", language)}
                      </label>
                    </div>
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        checked={
                          list.title.style.letterSpacing !== "normal" &&
                          list.title.style.letterSpacing !== undefined
                        }
                        onChange={(e) =>
                          onUpdateTitle({
                            style: {
                              ...list.title.style,
                              letterSpacing: e.target.checked
                                ? "2px"
                                : "normal",
                            },
                          })
                        ...
                        className="mr-2 h-4 w-4"
                      />
                      <label htmlFor="text-letterspacing" className="text-sm">
                        {translate("letter_spacing", language)}
                      </label>
                    </div>
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        id="text-border"
                        checked={
                          list.title.style.WebkitTextStroke !== undefined
                        }
                        onChange={(e) =>
                          onUpdateTitle({
                            style: {
                              ...list.title.style,
                              WebkitTextStroke: e.target.checked
                                ? "1px rgba(0,0,0,0.5)"
                                : undefined,
                            },
                          })
                        ...
                        className="mr-2 h-4 w-4"
                      />
                      <label htmlFor="text-border" className="text-sm">
                        {translate("outline", language)}
                      </label>
                    </div>
                  </div>
                </div>
        ...
        >
          ...
          >
            <h3 className="font-medium">
              {translate("standard_headers", language)} ({selectedHeadersCount}
              /10){" "}
              {isEmployeeList
          ...
          {expandedSections.headers && (
            <div className="p-3">
              <p className="text-sm mb-2 opacity-75">
                {translate("select_up_to_10_headers", language)} (
                {translate("first_last_name_required", language)})
              </p>
              ...
              <div className="space-y-2 max-h-60 overflow-y-auto scrollbar-custom">
                {standardHeaders.map((header) => (
                  <div key={header} className="flex items-center">
                    ...
                    >
                      {getHeaderNameByLang(header, language)}
                    </label>
                  </div>
                ))}
              </div>
        ...
        >
          ...
          >
            <h3 className="font-medium">
              {translate("custom_headers", language)}
            </h3>
            ...
            <div className="p-3">
              <div className="flex mb-3">
                <input
                  ...
                  placeholder={translate("new_header", language)}
                ...
                <motion.button
                  ...
                  className={`${buttonPrimary} px-3 py-2 rounded-r-lg flex items-center ${
                    !customHeaderInput.trim() ? "opacity-50" : ""
                  }`}
              ...
              {savedCustomHeaders.length === 0 && (
                <p className="text-sm opacity-75">
                  {translate("no_custom_headers", language)}
                </p>
              )}
            </div>
          )}
        ...
        >
          ...
          >
            <h3 className="font-medium">
              {translate("page_orientation", language)}
            </h3>
        ...
        >
          ...
          >
            <h3 className="font-medium">
              {translate("custom_message", language)}
            </h3>
            ...
            <div className="p-3 space-y-3">
              <div className="flex items-center">
                <input
                  ...
                  className="mr-2 h-4 w-4"
                />
                <label htmlFor="show-custom-message">
                  {translate("show_custom_message", language)}
                </label>
              </div>
              ...
              {list.customMessage.show && (
                <>
                  <div>
                    <label className="block mb-1 text-sm font-medium">
                      {translate("message_text", language)}
                    </label>
                    <input
                      type="text"
                      ...
                      placeholder={translate("example_message", language)}
                      className={`w-full p-2 rounded-lg border ${borderColor} ${inputBgColor}`}
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder={translate("example_name", language)}
                      className={`w-full p-2 rounded-lg border ${borderColor} ${inputBgColor}`}
                    />
                  </div>
        ...
        >
          ...
          >
            <h3 className="font-medium">
              {translate("country_header", language)}
            </h3>
            ...
            <div className="p-3 space-y-3">
              <div className="flex items-center">
                <input
                  ...
                  className="mr-2 h-4 w-4"
                />
                <label htmlFor="show-country-infos">
                  {translate("show_country_header", language)}
                </label>
              </div>
              ...
              {list.countryInfosHeader.show && (
                <div className="flex items-center">
                  <input
                    ...
                    className="mr-2 h-4 w-4"
                  />
                  <label htmlFor="is-cap">
                    {translate("cap_instead_of_academy", language)}
                  </label>
                </div>
              )}
            </div>
