          ...
          <div className={`flex items-center justify-between p-6 border-b ${
            ...
            <div className="flex-1">
              ...
              <p className={`text-sm ${
                ...
                {translate(event.type, language)} • {formatEventDuration(event)}
              </p>
            </div>
            <motion.button
                ...
                <div className={`p-4 rounded-lg border ${
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span>{new Date(event.createdAt).toLocaleDateString(language === 'fr' ? 'fr-FR' : 'en-US')}</span>
                    </div>
                    ...
                    {event.updatedAt && event.updatedAt !== event.createdAt && (
                      <div className="flex items-center gap-3">
                        ...
                        <span>{new Date(event.updatedAt).toLocaleDateString(language === 'fr' ? 'fr-FR' : 'en-US')}</span>
                      </div>
                    )}
                  </div>
                </div>
              ...
              <motion.div variants={sectionVariants} className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  {canDeleteEvent(event) && (
                    ...
                    >
                      <Trash2 size={16} />
                      {translate('delete_event', language)}
                    </motion.button>
                  )}
                  
                  {(!canEditEvent(event) && !canValidateEvent(event) && !canDeleteEvent(event)) && (
                    <div className={`p-4 rounded-lg border ${
                      theme === 'dark' 
                ...
                {event.validation.validatedAt && (
                  <div className={`p-3 rounded-lg border text-center ${
                    ...
                    <p className="text-sm">
                      ...
                      {new Date(event.validation.validatedAt).toLocaleDateString(language === 'fr' ? 'fr-FR' : 'en-US')}
                    </p>
                  </div>
                )}
              </motion.div>
