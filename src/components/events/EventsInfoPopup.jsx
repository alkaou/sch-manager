...
const EventsInfoPopup = ({ isOpen, onClose, theme }) => {
  ...
  const renderOverview = () => (
    ...
    >
      <div className="text-center">
        ...
        <h3 className="text-2xl font-bold mb-2">{translate('events_system_title', language)}</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          <div className="flex items-center mb-3">
            ...
            <h4 className="font-semibold">{translate('events_management', language)}</h4>
          </div>
        ...
        >
          <div className="flex items-center mb-3">
            ...
            <h4 className="font-semibold">{translate('smart_notifications', language)}</h4>
          </div>
          <p className={`text-sm ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>
        ...
        >
          <div className="flex items-center mb-3">
            ...
            <h4 className="font-semibold">{translate('voice_alerts', language)}</h4>
          </div>
          <p className={`text-sm ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>
        ...
        >
          <div className="flex items-center mb-3">
            ...
            <h4 className="font-semibold">{translate('event_validation', language)}</h4>
          </div>
          <p className={`text-sm ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>
  ...
  const renderFeatures = () => (
    <motion.div
      ...
      className="space-y-6"
    >
      <h3 className="text-xl font-bold mb-4">{translate('key_features', language)}</h3>
      ...
      <div className="space-y-4">
        {[
          ...
          <motion.div
            ...
            className={`flex items-start p-4 rounded-xl border ${theme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}
          >
            <div className={`p-3 ${getColorClasses(feature.color, 'light')} rounded-lg mr-4 flex-shrink-0`}>
              <feature.icon className={getColorClasses(feature.color, 'text')} size={24} />
            </div>
            <div>
  ...
  const renderWorkflow = () => (
    <motion.div
      ...
      className="space-y-6"
    >
      <h3 className="text-xl font-bold mb-4">{translate('event_workflow', language)}</h3>
      ...
      <div className="space-y-4">
        {[
          ...
          <motion.div
            ...
            className={`relative flex items-center p-4 rounded-xl border ${theme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}
          >
            <div className="flex items-center mr-4">
              <div className={`w-8 h-8 rounded-full flex items-center justify-center text-white font-bold ${
                step.status === 'pending' ? 'bg-yellow-500' :
                step.status === 'ongoing' ? 'bg-blue-500' :
                'bg-green-500'
              }`}>
                {step.step}
              </div>
  ...
  const renderNotifications = () => (
    <motion.div
      ...
      className="space-y-6"
    >
      <h3 className="text-xl font-bold mb-4">{translate('notification_system', language)}</h3>
      
      <div className="space-y-4">
        <motion.div
          whileHover={{ scale: 1.02 }}
          className={`p-4 rounded-xl border-2 border-orange-200 ${theme === 'dark' ? 'bg-orange-900/20' : 'bg-orange-50'}`}
        >
          <div className="flex items-center mb-3">
          ...
          <p className={`text-sm ${theme === 'dark' ? 'text-orange-200' : 'text-orange-700'} mb-3`}>
        ...
        <motion.div
          whileHover={{ scale: 1.02 }}
          className={`p-4 rounded-xl border-2 border-green-200 ${theme === 'dark' ? 'bg-green-900/20' : 'bg-green-50'}`}
        >
          <div className="flex items-center mb-3">
          ...
          <p className={`text-sm ${theme === 'dark' ? 'text-green-200' : 'text-green-700'} mb-3`}>
        ...
        <motion.div
          whileHover={{ scale: 1.02 }}
          className={`p-4 rounded-xl border-2 border-purple-200 ${theme === 'dark' ? 'bg-purple-900/20' : 'bg-purple-50'}`}
        >
          <div className="flex items-center mb-3">
          ...
          <p className={`text-sm ${theme === 'dark' ? 'text-purple-200' : 'text-purple-700'} mb-3`}>
        ...
        <motion.div
          whileHover={{ scale: 1.02 }}
          className={`p-4 rounded-xl border-2 border-blue-200 ${theme === 'dark' ? 'bg-blue-900/20' : 'bg-blue-50'}`}
        >
          <div className="flex items-center mb-3">
  ...
  const renderTips = () => (
    <motion.div
      ...
      className="space-y-6"
    >
      <h3 className="text-xl font-bold mb-4">{translate('expert_tips', language)}</h3>
      ...
      <div className="space-y-4">
        {[
          ...
          {
            icon: Users,
            title: translate('tip_collaboration', language),
            description: translate('tip_collaboration_desc', language),
            color: 'blue'
          }
        ].map((tip, index) => (
          <motion.div
          ...
          >
            <div className="flex items-start">
              <div className={`p-2 ${getColorClasses(tip.color, 'light')} rounded-lg mr-3 flex-shrink-0`}>
                <tip.icon className={getColorClasses(tip.color, 'text')} size={20} />
              </div>
              <div>
      ...
      >
        ...
        >
          ...
          <div className={`px-6 py-4 border-b ${theme === 'dark' ? 'border-gray-700 bg-gray-800' : 'border-gray-200 bg-gray-50'}`}>
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <div>
                  <h2 className="text-xl font-bold">{translate('events_help_center', language)}</h2>
                  <p className={`text-sm ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>
          ...
          <div className="flex h-[calc(90vh-120px)]">
            {/* Sidebar */}
            <div className={`w-64 ${theme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-gray-50 border-gray-200'} border-r overflow-y-auto`}>
              <div className="p-4">
