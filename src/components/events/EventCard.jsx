...
const EventCard = ({
  ...
  return (
    ...
    >
      {/* Badge de statut */}
      <div
        className={`absolute top-4 right-4 flex items-center gap-2 px-3 py-1 rounded-full text-white text-sm font-medium ${getStatusColor(
          currentStatus
        )}`}
      >
      ...
      {event.validation && (
        ...
        >
          <div className="text-sm font-medium text-green-600 dark:text-green-400 mb-1">
            ...
            {formatDate(event.validation.validatedAt)}
          </div>
          <div
            className={`text-xs ${
              theme === "dark" ? "text-gray-300" : "text-gray-600"
          ...
          >
            {translate("validation_indication_message", language)}
          </div>
        </motion.div>
      )}
    </motion.div>
